...
$select_query ="SELECT `modelo`, `cantidade`, `descricion`, `marca`, `prezo`, `foto` FROM `vehiculo_aluguer` WHERE `modelo`='$modelo'";
...
if ($cantidadeFinal > 0){
    $update_queryEliminar = "UPDATE `vehiculo_aluguer` SET `cantidade`='$cantidadeFinal' WHERE `modelo`='$modelo'";
